...
<body>
        ...
        <h2 class="display-2 m-0 d-none d-md-block d-lg-none">College News</h4>
        <h4 class="display-4 m-0 d-none d-sm-block d-md-none">College News</h4>
        <h5 class="display-5 m-0  d-block d-sm-none">College News</h5>
